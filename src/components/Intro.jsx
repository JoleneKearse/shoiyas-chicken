...
const Intro = () => {
  return (
    <section>
      ...
      <p className="text-lg text-brand-100 font-roboto leading-10 max-w-prose mx-auto lg:text-xl">
        We are completely <span className="text-brand-300 font-semibold">Gluten-Free</span> and <span className="text-brand-300 font-semibold">Halal</span>. Our meal options are <span className="text-brand-300 font-semibold">oven baked</span> and never deep fried.
      </p>
